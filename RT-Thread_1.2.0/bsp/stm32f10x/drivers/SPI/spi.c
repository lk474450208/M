...
void SPI1_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOC, ENABLE);	 //使能PB,PC,PE端口时钟
...
void SPI2_SetSpeed(rt_uint8_t SpeedSet)
{
	SPI2->CR1&=0XFFC7; 
	SPI2->CR1|=SpeedSet;
	SPI_Cmd(SPI2,ENABLE); 
...
rt_uint8_t SPI_WriteByte(SPI_TypeDef* SPIx,rt_uint8_t Byte)
{
